...
<head>
    ...
    <title>Nikki | Registration</title>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('dashboard_files/plugins/adminlte.min.css') }}">
</head>
<body class="hold-transition register-page">
<div class="register-box">
    <div class="register-logo">
        <a href="#"><b>Nikki</b>Registration</a>
    </div>
...
<!-- AdminLTE App -->
<script src="{{ asset('dashboard_files/plugins/adminlte.min.js') }}"></script>
</body>
</html>
